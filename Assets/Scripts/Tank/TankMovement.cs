...
public class TankMovement : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        else if (CrossPlatformInputManager.GetAxis("Vertical1") > 0)
            movement += m_Speed * Time.deltaTime * transform.forward;
    ...
    private void Turn()
    {
        ...
        if (CrossPlatformInputManager.GetAxis("Horizontal1") < 0)
            turn = -1 * m_TurnSpeed * Time.deltaTime;
        else if (CrossPlatformInputManager.GetAxis("Horizontal1") > 0)
            turn = 1 * m_TurnSpeed * Time.deltaTime;
